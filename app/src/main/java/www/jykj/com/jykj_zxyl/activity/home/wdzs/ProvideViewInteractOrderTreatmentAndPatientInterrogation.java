...
public class ProvideViewInteractOrderTreatmentAndPatientInterrogation implements java.io.Serializable {
	...
	private Integer limitImgTextShow;//图文就诊(限制)-医生解答剩余数量
	...
	private Integer limitAudioShow;//音频就诊(限制)-剩余通话时间
	...
	private Integer limitVideoShow;//视频就诊(限制)-剩余通话时间
	...
	public void setLimitPhoneShow(String limitPhoneShow) {
