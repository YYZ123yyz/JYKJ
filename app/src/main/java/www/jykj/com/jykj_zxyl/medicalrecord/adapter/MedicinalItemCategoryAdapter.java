 ...
 */
public class MedicinalItemCategoryAdapter extends RecyclerView.Adapter<MedicinalItemCategoryAdapter.ViewHolder> {
    private Context context;
    private List<MedicinalTypeBean> list;
    ...
    public MedicinalItemCategoryAdapter(Context mContext, List<MedicinalTypeBean> list){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MedicinalTypeBean inspectionItemBean = list.get(position);
        holder.mTvInspectionItemName.setText(inspectionItemBean.getAttrName());
