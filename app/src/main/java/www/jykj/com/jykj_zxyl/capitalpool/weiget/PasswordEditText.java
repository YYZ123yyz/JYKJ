...
public class PasswordEditText extends AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        mMaxCount = typedArray.getInt(R.styleable.PasswordEditText_maxCount, mMaxCount);
        mCircleColor = typedArray.getColor(R.styleable.PasswordEditText_pwdcircleColor, mCircleColor);
        mCircleRadius = typedArray.getDimensionPixelOffset(R.styleable.PasswordEditText_pwdCircleRadius, mCircleRadius);
        mStrokeColor = typedArray.getColor(R.styleable.PasswordEditText_strokeColor, mStrokeColor);
        mDevideLineColor = typedArray.getColor(R.styleable.PasswordEditText_devideLineColor, mDevideLineColor);
        mDivideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PasswordEditText_divideLineWidth, mDivideLineWidth);
        mRectAngle = typedArray.getDimensionPixelOffset(R.styleable.PasswordEditText_rectAngle, mRectAngle);
