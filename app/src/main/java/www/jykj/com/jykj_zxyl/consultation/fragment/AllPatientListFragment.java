...
import www.jykj.com.jykj_zxyl.consultation.AllPatientListPresenter;
 ...
 */
public class AllPatientListFragment extends AbstractMvpBaseFragment<AllPatientListContract.View
        , AllPatientListPresenter> implements AllPatientListContract.View {
    ...
    protected void initData() {
        super.initData();
        mPresenter.sendGetAllPatientRequest(mApp.mViewSysUserDoctorInfoAndHospital
    ...
    private void initRecyclerView(){
        ...
        mMessageInfoRecycleAdapter.setOnItemClickListener(new MessageInfoRecycleAdapter.OnItemClickListener() {
            ...
            public void onClick(int position) {
                ...
                intent.setClass(Objects.requireNonNull(AllPatientListFragment.this.getContext()), ChatActivity.class);
    ...
    @Override
    public void getAllPatientResult(List<InteractPatient> list) {
