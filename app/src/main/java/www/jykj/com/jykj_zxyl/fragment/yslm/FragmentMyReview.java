...
import www.jykj.com.jykj_zxyl.activity.home.tjhz.ApplicationAuditDealActivity;
        ...
        new Thread(){
            public void run(){
                try {
                    ...
                    provideViewUnionDoctorDetailInfo.setDoctorCode(mApp.mViewSysUserDoctorInfoAndHospital.getDoctorCode());
