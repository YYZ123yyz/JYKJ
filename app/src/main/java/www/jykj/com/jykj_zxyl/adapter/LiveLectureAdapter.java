...
public class LiveLectureAdapter extends RecyclerView.Adapter<LiveLectureAdapter.ViewHolder> {
    ...
    public LiveLectureAdapter(List<ProvideLiveBroadcastDetails> datas) {
        this.datas = datas;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lecture_live_items, viewGroup, false);
