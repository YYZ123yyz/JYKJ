 ...
 * 签约患者
 */
public class SignedPatientFragment extends AbstractMvpBaseFragment<SignedPatientContract.View,
    ...
    public void onResume() {
        super.onResume();
        mPresenter.sendOperNumberRequest("10","1",mApp.loginDoctorPosition,mApp.mViewSysUserDoctorInfoAndHospital.getDoctorCode(),"1");
    }
    ...
    @OnClick({R.id.iv_right_part,R.id.tv_start_age
            ,R.id.tv_end_age,R.id.tv_reset_btn,R.id.tv_ensure_btn})
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_reset_btn:
                ...
                for (Fragment fragment : viewList) {
                    SignedPatientChildFragment childFragment
                            = (SignedPatientChildFragment) fragment;
...
//                }
                ...
                SignedPatientChildFragment signedPatientChildFragment
                        = (SignedPatientChildFragment) viewList.get(currentPos);
                if (signedPatientChildFragment!=null) {
                    signedPatientChildFragment.searchData(patientName, StringUtils.isNotEmpty(startAge) ?
    ...
    private void initViewPager(){
        ...
        // 初始化ViewPager适配器
        tableViewAdapter = new WarningTableViewAdapter(getChildFragmentManager(),viewList,titleList);
        // 给ViewPager设置适配器
