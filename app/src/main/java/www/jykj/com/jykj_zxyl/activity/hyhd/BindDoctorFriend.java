...
public class BindDoctorFriend {
    ...
    public String getBindingDoctorQrCode() {
        return bindingDoctorQrCode;
    }

    public void setBindingDoctorQrCode(String bindingDoctorQrCode) {
        this.bindingDoctorQrCode = bindingDoctorQrCode;
    }
