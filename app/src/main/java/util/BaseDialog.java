...
public class BaseDialog extends Dialog implements
	...
	private LinkdoodTextView mHtvTitle;// 标题
	private View mViewTitleLine;// 标题分割线
	private LinearLayout mLayoutContent;// 内容根布局
	private LinkdoodTextView mHtvMessage;// 内容
	...
	public BaseDialog(Context context) {
		...
		mContext = context;
		setContentView(R.layout.view_common_dialog_generic);
		initViews();
		initEvents();
		setCancelable(true);
	...
	private void initViews() {
		...
		mHtvTitle = (LinkdoodTextView) findViewById(R.id.dialog_generic_htv_title);
		...
		mHtvMessage = (LinkdoodTextView) findViewById(R.id.dialog_generic_htv_message);
