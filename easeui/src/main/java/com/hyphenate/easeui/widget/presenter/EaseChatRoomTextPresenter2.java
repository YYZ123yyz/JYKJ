...
import com.hyphenate.easeui.widget.chatrow.EaseChatRoomRowText2;
...
public class EaseChatRoomTextPresenter2 extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatRoomTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRoomRowText2(cxt, message, position, adapter);
    }
