 ...
 * 检测类型
 */
public class Item_Rv_detectAdapter extends RecyclerView.Adapter<Item_Rv_detectAdapter.ViewHolder> {
    ...
    public Item_Rv_detectAdapter(List<GetdetailsBean.OrderDetailListBean> list, Context context, SigningDetailsActivity mainActivity) {
        mContext = context;
        datas = list;
