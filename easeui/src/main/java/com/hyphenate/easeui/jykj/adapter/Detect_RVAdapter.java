...
public class Detect_RVAdapter extends RecyclerView.Adapter<Detect_RVAdapter.ViewHolder> {
    private List<DetectBean> detectBean;
    private Context mContext;
    private OnItemClickListener mOnItemClickListener;


    public Detect_RVAdapter(List<DetectBean> list, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_detect_choice, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
        viewHolder.tv_zzxx_mc.setText(detectBean.get(i).getConfigDetailName());
        if (detectBean.get(i).isChoice())
