...
import com.jykj.live.lvb.liveroom.debug.GenerateTestUserSig;
...
import com.jykj.live.lvb.liveroom.roomutil.commondef.LoginInfo;
import com.jykj.live.lvb.liveroom.roomutil.misc.CommonAppCompatActivity;
import com.jykj.live.lvb.liveroom.roomutil.misc.NameGenerator;
import com.jykj.live.lvb.liveroom.ui.fragment.LiveRoomChatFragment;
import com.jykj.live.lvb.liveroom.ui.fragment.LiveRoomListFragment;
...
//                        + ", mode = " + mAudioManager.getMode(), Toast.LENGTH_SHORT).show();
    ...
    private void initializeLiveRoom() {
        setTitle("连接中...");
        String usercachname = "jykjdocter+JYKJDOCTER-jykjdocter";
        //usercachname = "com.tencent.demo";
        SharedPreferences sp = getSharedPreferences(usercachname, Context.MODE_PRIVATE);
